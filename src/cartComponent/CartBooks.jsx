...
const CartBooks = () => {
  const { cartItems,  decrementQty, incrementQty,removeBook } =
    useCartStore();
  return (
            ...
            >
              ...
              <div className="col-span-6 flex gap-4">
                ...
                <div className="flex flex-col justify-start gap-1">
                  ...
                  <p className="text-[10px] text-[#181818] mt-1 uppercase">
                    ASIN:{" "}
              ...
              <div className="col-span-2 flex justify-center items-center gap-3">
                <button
                  ...
                  className="w-6 h-6 flex items-center justify-center rounded-full border border-pink-500 text-pink-500 hover:bg-pink-50 cursor-pointer"
                >
                  -
                </button>
              ...
              <div className="col-span-1 flex justify-center items-center">
                <button
                  ...
                  className="text-pink-300 cursor-pointer hover:text-pink-500 transition-colors"
                >
                  <RiDeleteBin5Line />
                </button>
              </div>
