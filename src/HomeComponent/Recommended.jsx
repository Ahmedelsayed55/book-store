          ...
          >
            ...
            <div className="flex flex-col w-full gap-6">
              ...
              <div className="w-full flex gap-4">
                <button onClick={()=> addToCart(data)} className="cursor-pointer hover:bg-white hover:text-[#D9176C] border border-[#D9176C] text-[16px] py-3.5 px-3 md:px-10 xl:px-21 flex gap-2 items-center bg-[#D9176C] text-white rounded-2xl"> Add to Cart <BsCart3 /></button>
                <button onClick={()=> addToFavorites(data)} className="cursor-pointer hover:bg-[#D9176C] hover:text-white text-2xl text-[#D9176C] border border-[#D9176C] hover:border-[#d6d6d6] p-3.5 rounded-md "><GrFavorite /></button>
              </div>
            </div>
          </div>
        ))}
