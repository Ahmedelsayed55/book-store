...
const CheckAndMoveBooks = () => {
  const { favoritesItems, total } = useFavoritesStore();
  return (
    <div className="flex justify-center items-center">
      <div className=" flex flex-col md:flex-row  gap-4 ">
        <button className="text-[#D9176C] cursor-pointer transition duration-300 hover:bg-white text-[16px] border border-[#D9176C] bg-[#D9176C1A] px-6 py-3.5 rounded-lg ">
          Move to cart
        </button>
